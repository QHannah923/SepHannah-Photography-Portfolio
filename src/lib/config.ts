...
export interface SocialLink {
  id: string;
  platform: 'wechat' | 'instagram' | 'xiaohongshu' | 'douyin' | 'email' | 'custom';
  label: string;
...
export const defaultConfig: SiteConfig = {
  photographer: {
    ...
    tagline: '布里斯班婚纱摄影师 · 用镜头定格永恒',
    bio: '欢迎来到我的作品集。这里收录了我最珍视的摄影作品，每一张照片都承载着当下的故事与情感。',
  },
  socialLinks: [
    { id: '1', platform: 'wechat', label: '微信', value: 'SepHannah', icon: 'wechat' },
    ...
    { id: '4', platform: 'xiaohongshu', label: '小红书', value: 'Sep_小黄 / 布里斯班婚纱摄影师Hannah', url: 'https://www.xiaohongshu.com/search_result?keyword=Sep_小黄', icon: 'xiaohongshu' },
    { id: '5', platform: 'douyin', label: '抖音', value: 'Sep_小黄', url: 'https://www.douyin.com/search/Sep_小黄', icon: 'douyin' },
  ],
  portfolio: [
    {
      id: '1',
